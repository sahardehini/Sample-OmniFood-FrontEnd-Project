...
.one-section .section-header .header-nav ul {
    display: flex;
}

.one-section .section-header .header-nav .nav-ul li {
    margin: 0 1rem;
}

.one-section .section-header .header-nav .nav-ul .nav-search a {
